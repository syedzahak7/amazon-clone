...
class ProductCard extends StatelessWidget {
 ...
 // final ProductCardOnTaped? ontap;
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Stack(
              children: [
                Image.asset('images/detail_sofa.png', width: 182, height: 182),
                Positioned(
                  top: 16,
                  right: 16,
                  child: Image.asset('images/not_collected@2x.png', width: 28, height: 28),
                )
              ],
            ),
          ),
  ...
  Widget _buildSoldPoint(double star, int sold) {
    return Row(
      children: [
        Image.asset('images/start@2x.png', width: 20, height: 20),
